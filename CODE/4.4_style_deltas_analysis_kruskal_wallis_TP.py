...
stylo_df = pd.read_csv("4.4_stylometrics_report_grouped_features_TP")

# Load the grouped stylometric dataset - Detailed Features (UNCOMMENT)
#stylo_df = pd.read_csv("4.4_stylometrics_report_detailed_features_TP")
...
# Define stylistic features - Detailed
"""
stylistic_features = ['avg_w_len',
 'tot_short_w',
 'tot_upper',
 'avg_s_len',
 'hapax',
